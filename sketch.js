...
function setup() {
  ...
  alignSlider.position(340,550);
  cohesionSlider.position(475,550);
  separationSlider.position(610,550);


  input_elang = createInput(1)
  input_elang.position(25, 310)
  input_elang.size(100)
  input_elang.changed(populationEagle)

  input_snake = createInput(2)
  input_snake.position(25, 430)
  input_snake.changed(populationSnake)

  input_mice = createInput(20)
  input_mice.position(25, 550)
...
function draw() {
  ...
  textSize(10);
  fill(0);
  text(`Eagle Count: ${eagleCount}`, 25, 40);
  text(`Snake Count: ${snakeCount}`, 25, 65);
  text(`Mice Count: ${miceCount}`, 25, 90);
